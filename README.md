...
Also on this site used images in format webp and svg sprites to animate social media icons.
* SITE RESPONSIVENESS  
Using media queries site worked out on each device.   
In this layout has a section with images tiles.  
